...
const CreateNewPassword = () => {
  return (
    <section className="w-[97vw] md:w-[70vw] flex items-center justify-center lg:justify-end">
      <Link to={"/create"} className="bg-green-500 cursor-pointer hover:scale-99 transition-all w-[95%] lg:w-fit lg:px-8 px-4 gap-2 py-2 flex items-center justify-center rounded-full ">
