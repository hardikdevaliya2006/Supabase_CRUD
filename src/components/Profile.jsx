    ...
    <>
      ...
      <div className="userMamgement w-[85%]">
        <div class="flex flex-col gap-2 items-center justify-center">
          <Link
            className="p-2 flex items-center justify-center gap-2 font-semibold w-full text-yellow-400 border border-yellow-500/50 bg-yellow-500/10 rounded-lg cursor-pointer"
            data-discover="true"
          >
          ...
          <Link
            className="p-2 flex items-center justify-center gap-2 font-semibold w-full text-blue-400 border border-blue-500/50 bg-blue-500/10 rounded-lg cursor-pointer"
            data-discover="true"
          >
          ...
          <button className="p-2 flex items-center justify-center gap-2 font-semibold w-full text-green-400 border border-green-500/50 bg-green-500/10 rounded-lg cursor-pointer">
            <span>Logout</span>
            <span>
              <IoExitOutline />
            </span>
          </button>
          <button className="p-2 flex items-center justify-center gap-2 font-semibold w-full text-red-400 border border-red-500/40 bg-red-500/10 rounded-lg cursor-pointer">
